...
if(keyboard_check_pressed(vk_enter)) then sk_animationState_play(state,"walk",-1);
if(keyboard_check_released(vk_enter)) then sk_animationState_play(state,"stand",-1);
