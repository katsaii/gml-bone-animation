...
gml_pragma("global","sk_struct_type_add(sk_type_timeline_colour,SK_TIMELINE_COLOUR.sizeof,sk_construct_timeline,sk_destruct_timeline,SK_TIMELINE_COLOUR.kf_ENTRIES);");
