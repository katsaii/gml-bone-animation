...
gml_pragma("global","sk_struct_type_add(sk_type_timeline_transform,SK_TIMELINE_TRANSFORM.sizeof,sk_construct_timeline,sk_destruct_timeline,SK_TIMELINE_TRANSFORM.kf_ENTRIES);");
