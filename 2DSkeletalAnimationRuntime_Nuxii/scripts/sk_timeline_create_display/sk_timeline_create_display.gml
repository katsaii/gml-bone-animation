...
gml_pragma("global","sk_struct_type_add(sk_type_timeline_display,SK_TIMELINE_DISPLAY.sizeof,sk_construct_timeline,sk_destruct_timeline,SK_TIMELINE_DISPLAY.kf_ENTRIES);");
