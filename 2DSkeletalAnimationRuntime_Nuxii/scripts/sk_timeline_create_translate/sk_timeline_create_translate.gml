...
gml_pragma("global","sk_struct_type_add(sk_type_timeline_translate,SK_TIMELINE_TRANSLATE.sizeof,sk_construct_timeline,sk_destruct_timeline,SK_TIMELINE_TRANSLATE.kf_ENTRIES);");
