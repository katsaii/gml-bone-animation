...
if(sk_translateMix!=0){
	...
	sk_bone[@ sk_bone_var_x] = sk_bone[sk_bone_var_x]+sk_targetX*sk_translateMix;
	sk_bone[@ sk_bone_var_y] = sk_bone[sk_bone_var_y]+sk_targetY*sk_translateMix;
	sk_updated = true;
}
// set scale
...
if(sk_scaleMix!=0){
	...
	sk_bone[@ sk_bone_var_m00] = sk_bone[sk_bone_var_m00]*sk_xscale;
	sk_bone[@ sk_bone_var_m01] = sk_bone[sk_bone_var_m01]*sk_xscale;
	sk_bone[@ sk_bone_var_m10] = sk_bone[sk_bone_var_m10]*sk_yscale;
	sk_bone[@ sk_bone_var_m11] = sk_bone[sk_bone_var_m11]*sk_yscale;
	sk_updated = true;
}
// set shear
...
if(sk_shearMix!=0){
	...
	var sk_dx = sk_bone[sk_bone_var_m10];
	var sk_dy = sk_bone[sk_bone_var_m11];
	sk_bone[@ sk_bone_var_m10] = sk_cosine*sk_dx + sk_sine*sk_dy;
	sk_bone[@ sk_bone_var_m11] = -sk_sine*sk_dx + sk_cosine*sk_dy;
	sk_updated = true;
}
// set rotation
