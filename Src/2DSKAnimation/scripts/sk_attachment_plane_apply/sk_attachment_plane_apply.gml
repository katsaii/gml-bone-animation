...
/// @param colour
/// @param alpha
var sk_region = argument0[sk_attachment_plane_var_regionData];
if(sk_region!=undefined){
	// obtain world transform by multiplying attachment matrix by bone matrix
	var sk_att_dx = argument0[sk_attachment_plane_var_x];
	var sk_att_dy = argument0[sk_attachment_plane_var_y];
	var sk_att_m00 = argument0[sk_attachment_plane_var_m00]; // x component of x
	var sk_att_m01 = argument0[sk_attachment_plane_var_m01]; // y component of x
	var sk_att_m10 = argument0[sk_attachment_plane_var_m10]; // x component of y
	var sk_att_m11 = argument0[sk_attachment_plane_var_m11]; // y component of y
	var sk_bone_x = argument2[sk_bone_var_x];
	var sk_bone_y = argument2[sk_bone_var_y];
	var sk_bone_m00 = argument2[sk_bone_var_m00];
	var sk_bone_m01 = argument2[sk_bone_var_m01];
	var sk_bone_m10 = argument2[sk_bone_var_m10];
	var sk_bone_m11 = argument2[sk_bone_var_m11];
