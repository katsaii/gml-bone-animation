...
/// @param bone
var sk_mx = argument0[sk_bone_var_x];
var sk_my = argument0[sk_bone_var_y];
var sk_m00 = argument0[sk_bone_var_m00];
var sk_m01 = argument0[sk_bone_var_m01];
var sk_m10 = argument0[sk_bone_var_m10];
var sk_m11 = argument0[sk_bone_var_m11];
...
if(sk_parent!=undefined){
	...
	var sk_xx = sk_mx-sk_parent[sk_bone_var_x];
	var sk_yy = sk_my-sk_parent[sk_bone_var_y];
