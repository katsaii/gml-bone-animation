...
switch(sk_mixPose){
	...
	break;
	case SK_MIX_ADD: 
		sk_target[@ sk_data_bone.appliedRotation] = sk_target[sk_data_bone.appliedRotation]+sk_r*sk_alpha;
	break;
	case SK_MIX_OVERWRITE:
		sk_target[@ sk_data_bone.setupRotation] = sk_target[sk_data_bone.setupRotation]+sk_r*sk_alpha;
	break;
}